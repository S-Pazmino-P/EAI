...
| **ADAS13** | Alzheimer's Disease Assessment Scale - Cognitive Subscale (13-item) | LOINC | 85638-5 | LCDS v3.00 - Cognitive patterns [CMS Assessment] |
| **ADASQ4** | ADAS-Cog Delayed Word Recall - Delayed recall component of ADAS-Cog | LOINC | 54618-4 | Memory/recall ability [MDSv3] |
...
| **LDELTOTAL** | Logical Memory Delayed Recall Total - Delayed recall from WMS-R Logical Memory | LOINC | 54618-4 | Memory/recall ability [MDSv3] |
...
| **RAVLT_immediate** | Rey Auditory Verbal Learning Test Immediate Recall - Sum across 5 trials | LOINC | 106731-3 | Verbal memory count |
...
| **mPACCdigit** | Modified Preclinical Alzheimer's Cognitive Composite with Digit Symbol | LOINC | 100929-9 | Digital confidence score [R-Outcomes] |
...
|--------|-------------|-----------|---------|
| **ADAS11** | Alzheimer's Disease Assessment Scale - Cognitive Subscale (11-item) | ADAS11 | Cognitive assessment score - 11-item version |
...
| **DIGITSCOR** | Digit Symbol Substitution Score - WAIS-R Digit Symbol subtest | DIGITSCOR | Processing speed, attention, and executive function |
| **DX** | Diagnosis - Current clinical diagnosis at the time of visit | DX | Clinical diagnosis classification |
...
| **TRABSCOR** | Trail Making Test Part B Time - Time to complete TMT Part B | TRABSCOR | Executive function and mental flexibility |
...
```json
{
  ...
  "concept": [
    ...
    {
      "code": "DX",
      "display": "Clinical diagnosis classification"
    },
    {
      "code": "EXAMDATE",
...
| Category | Count |
|----------|-------|
| Standard LOINC/SNOMED codes | 27 |
| ADNI custom codes | 35 |
